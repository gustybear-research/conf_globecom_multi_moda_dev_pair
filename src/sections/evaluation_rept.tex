...
\end{subfigure}
\caption{Left to right: (a) Implementation of SIENNA with, an Android application, a contact sensor, and mmWave Radar; (b) Eavesdropper records signal from radar.}
