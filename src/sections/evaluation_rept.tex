...
\hspace{\fill}
\begin{subfigure}[t]{0.24\textwidth}
\includegraphics[width=\textwidth]{figures/friend_similarity2.eps}
\end{subfigure}
\hspace{\fill}
\begin{subfigure}[t]{0.24\textwidth}
\includegraphics[width=\textwidth,height=\textwidth]{figures/attack_similarity2.eps}
\end{subfigure}
\hspace{\fill}
\begin{subfigure}[t]{0.24\textwidth}
\includegraphics[width=\textwidth,height=\textwidth]{figures/slant-ranges2.eps}
\end{subfigure}
